...
<body>
    <div id="app">
        ...
        <div class="container-fluid vh-100">
            <div class="row h-100">
                <nav id="sidebarMenu" class="offcanvas-md offcanvas-start col-md-3 col-lg-2 d-md-block bg-dark"
                    tabindex="-1" aria-labelledby="offcanvasLabel" data-bs-scroll="true" data-bs-backdrop="true">
